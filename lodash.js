...
const myEmployeesAges = _.map(myEmployees, "ages"); // use map to get ages here.
...
const purchasesByMonth = ._groupBy(purchases,"month") // Use groupBy to group the purchases by the month that they were made.

// Bonus Points
const totalByMonth = ._groupBy(purchases, "price"); // Use the grouped purchasesByMonth and reduce to create a totalByMonth object.
